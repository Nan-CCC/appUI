...
<template>
  <view class="content">
    <uni-forms :rules="rules" :model="form" ref="formRef">
      ...
      <uni-forms-item name="receiver" class="form-item">
        ...
        <input class="input" placeholder="请填写收货⼈姓名" v-model="form.receiver" />
      </uni-forms-item>
      <uni-forms-item name="contact" class="form-item">
        <text class="label">⼿机号码</text>
        <input class="input" placeholder="请填写收货⼈⼿机号码" v-model="form.contact" />
      </uni-forms-item>
  ...
  <!-- 提交按钮 -->
  <button @tap="onSubmit" class="button">保存并使⽤</button>
</template>
